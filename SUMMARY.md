...
* [Java](./Java/README.md)
  ...
  * [EffectiveJava](./Java/EffectiveJava/README.md)
    * [创建和销毁对象](./Java/EffectiveJava/1.创建和销毁对象.md)
    * [对所有对象都适用的方法](./Java/EffectiveJava/2.对所有对象都适用的方法.md)
    * [类与接口](./Java/EffectiveJava/3.类与接口.md)
    * [泛型](./Java/EffectiveJava/4.泛型.md)
    * [枚举与注释](./Java/EffectiveJava/5.枚举和注释.md)
    * [Lambda和Stream](./Java/EffectiveJava/6.Lambda和Stream.md)
    * [方法](./Java/EffectiveJava/7.方法.md)
    * [通用编程](./Java/EffectiveJava/8.通用编程.md)
    * [异常](./Java/EffectiveJava/9.异常.md)
    * [同步](./Java/EffectiveJava/10.同步.md)
    * [序列化](./Java/EffectiveJava/11.序列化.md)
